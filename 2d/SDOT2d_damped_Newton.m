function [w_0,max_percent_err,v_0,EXITFLAG] = SDOT2d_damped_Newton(w_0,X,target_vols,bx,periodic,percent_tol)
% [w_0,max_percent_err,v_0,EXITFLAG] = SDOT2d_damped_Newton(w_0,X,target_vols,bx,periodic,percent_tol)
%
...
%
% bx=[xmin, ymin, xmax, ymax] is a 1-by-4 array containing the coordinates of two
% opposing corners of the rectangular box
%
...
% epsilon below
[v_0,~,~] = mexPD_2d(bx,X,w_0,periodic);
...
while(err_0>tol)
    ...
    [~,Dg,H,~]=kantorovich2d(w_0,X,target_vols,bx,periodic);
    ...
    while(backtracking)
        ...
        [v_l,~,~]=mexPD_2d(bx,X,w_l,periodic);
