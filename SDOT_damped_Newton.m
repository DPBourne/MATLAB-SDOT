function [w_0,max_percent_err,v_0,EXITFLAG] = SDOT_damped_Newton(w_0,X,target_vols,bx,periodic,percent_tol)
% [w_0,max_percent_err,v_0,EXITFLAG] = SDOT_damped_Newton(w_0,X,target_vols,bx,periodic,percent_tol)
%
